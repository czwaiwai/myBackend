(function(f,g,c){if(!Object.create){Object.create=function(k){if(arguments.length>1){throw new Error("Object.create implementation only accepts the first parameter.")}function j(){}j.prototype=k;return new j()}}if(!Object.keys){Object.keys=function(m){if(m!==Object(m)){throw new TypeError("Object.keys called on a non-object")}var j=[],l;for(l in m){if(Object.prototype.hasOwnProperty.call(m,l)){j.push(l)}}return j}}if(!Date.now){Date.now=function a(){return(new Date).valueOf()}}if(!Function.prototype.bind){Function.prototype.bind=function(j){if(typeof this!=="function"){throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable")}var n=Array.prototype.slice.call(arguments,1),m=this,k=function(){},l=function(){return m.apply(this instanceof k&&j?this:j||f,n.concat(Array.prototype.slice.call(arguments)))};k.prototype=this.prototype;l.prototype=new k();return l}}if(!String.prototype.trim){String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")}}if(!Array.isArray){Array.isArray=function(j){return Object.prototype.toString.call(j)==="[object Array]"}}if(typeof Array.prototype.forEach!="function"){Array.prototype.forEach=function(m,l){var k,j;for(k=0,j=this.length;k<j;++k){if(k in this){m.call(l,this[k],k,this)}}}}if(typeof Array.prototype.map!="function"){Array.prototype.map=function(n,m){var j=[];if(typeof n==="function"){for(var l=0,o=this.length;l<o;l++){j.push(n.call(m,this[l],l,this))}}return j}}if(typeof Array.prototype.filter!="function"){Array.prototype.filter=function(n,m){var j=[];if(typeof n==="function"){for(var l=0,o=this.length;l<o;l++){n.call(m,this[l],l,this)&&j.push(this[l])}}return j}}if(typeof Array.prototype.some!="function"){Array.prototype.some=function(m,l){var o=false;if(typeof m==="function"){for(var j=0,n=this.length;j<n;j++){if(o===true){break}o=!!m.call(l,this[j],j,this)}}return o}}if(typeof Array.prototype.every!="function"){Array.prototype.every=function(m,l){var o=true;if(typeof m==="function"){for(var j=0,n=this.length;j<n;j++){if(o===false){break}o=!!m.call(l,this[j],j,this)}}return o}}if(typeof Array.prototype.indexOf!="function"){Array.prototype.indexOf=function(m,n){var l=-1;n=n*1||0;for(var j=0,o=this.length;j<o;j++){if(j>=n&&this[j]===m){l=j;break}}return l}}if(typeof Array.prototype.lastIndexOf!="function"){Array.prototype.lastIndexOf=function(m,n){var l=-1,o=this.length;n=n*1||o-1;for(var j=o-1;j>-1;j-=1){if(j<=n&&this[j]===m){l=j;break}}return l}}if(typeof Array.prototype.reduce!="function"){Array.prototype.reduce=function(o,j){var n=j,l=0,m=this.length;if(typeof j==="undefined"){n=this[0];l=1}if(typeof o==="function"){for(l;l<m;l++){this.hasOwnProperty(l)&&(n=o(n,this[l],l,this))}}return n}}if(typeof Array.prototype.reduceRight!="function"){Array.prototype.reduceRight=function(o,j){var n=this.length,l=n-1,m=j;if(typeof j==="undefined"){m=this[n-1];l--}if(typeof o==="function"){for(l;l>-1;l-=1){this.hasOwnProperty(l)&&(m=o(m,this[l],l,this))}}return m}}var i={querySelector:function(j){return i.querySelectorAll.call(this,j)[0]||null},querySelectorAll:function(j){return d(Sizzle(j,this))},getElementsByClassName:function(j){return this.querySelectorAll("."+j.trim().replace(/\s+/,"."))},addEventListener:function(m,o,j){var l=this,k="";if(m=="input"){m="propertychange"}if(typeof o!="function"){return}var n=function(p){p=p||f.event||{};if(!p.target){p.target=p.srcElement}if(!p.preventDefault){p.preventDefault=function(){p.returnValue=false}}if(m=="propertychange"){if(p.propertyName!=="value"||l.r_oldvalue===l.value){return}l.r_oldvalue=l.value}return o.call(l,p||{})};n.initFuncHandle=o;l.attachEvent("on"+m,n);if(l["event"+m]){l["event"+m].push(n)}else{l["event"+m]=[n]}},dispatchEvent:function(k){var j=k&&k.type;if(j&&this["event"+j]){k.target=this;this["event"+j].forEach(function(l){k.timeStamp=Date.now();l.call(this,k)}.bind(this))}},removeEventListener:function(k,m,j){var l=this["event"+k];if(Array.isArray(l)){this["event"+k]=l.filter(function(n){if(n.initFuncHandle===m){this.detachEvent("on"+k,n);return false}return true}.bind(this))}}};var d=function(j){j.forEach(function(m,k){for(var l in i){m[l]=i[l].bind(m)}});return j};g.querySelector=function(j){return g.querySelectorAll(j)[0]||null};g.querySelectorAll=function(j){var k=Sizzle(j);return d(k)};if(!g.getElementsByClassName){g.getElementsByClassName=function(j){return i.getElementsByClassName.call(g,j)}}if(typeof g.addEventListener=="undefined"){[f,g].forEach(function(j){j.addEventListener=function(l,m,k){i.addEventListener.call(j,l,m,k)};j.dispatchEvent=function(k){i.dispatchEvent.call(j,k)};j.removeEventListener=function(eventType,funcHandle,useCapture){i.removeEventListener.call(j,eventType,funcHandle,useCapture)}})}if(!g.createEvent){g.createEvent=function(j){var k={};switch(j){case"Event":case"Events":case"HTMLEvents":k={initEvent:function(m,n,l){k.type=m;k.canBubble=n||false;k.cancelable=l||false;delete (k.initEvent)},bubbles:false,cancelBubble:false,cancelable:false,clipboardData:c,currentTarget:null,defaultPrevented:false,eventPhase:0,returnValue:true,srcElement:null,target:null,timeStamp:Date.now(),type:""};break;case"MouseEvents":k={initMouseEvent:function(p,z,q,y,u,s,r,o,m,n,l,x,w,t,v){k.type=p;k.canBubble=z||false;k.cancelable=q||false;k.view=y||null;k.screenX=s||0;k.screenY=r||0;k.clientX=o||0;k.clientY=m||0;k.ctrlKey=n||false;k.altKey=l||false;k.shiftKey=x||false;k.metaKey=w||false;k.button=t||0;k.relatedTarget=v||null;delete (k.initMouseEvent)},altKey:false,bubbles:false,button:0,cancelBubble:false,cancelable:false,charCode:0,clientX:0,clientY:0,clipboardData:c,ctrlKey:false,currentTarget:null,dataTransfer:null,defaultPrevented:false,detail:0,eventPhase:0,fromElement:null,keyCode:0,layerX:0,layerY:0,metaKey:false,offsetX:0,offsetY:0,pageX:0,pageY:0,relatedTarget:null,returnValue:true,screenX:0,screenY:0,shiftKey:false,srcElement:null,target:null,timeStamp:Date.now(),toElement:null,type:"",view:null,webkitMovementX:0,webkitMovementY:0,which:0,x:0,y:0};break;case"UIEvents":k={initUIEvent:function(n,p,m,l,o){k.type=n;k.canBubble=p||false;k.cancelable=m||false;k.view=l||null;k.detail=o||0;delete (k.initUIEvent)},bubbles:false,cancelBubble:false,cancelable:false,charCode:0,clipboardData:c,currentTarget:null,defaultPrevented:false,detail:0,eventPhase:0,keyCode:0,layerX:0,layerY:0,pageX:0,pageY:0,returnValue:true,srcElement:null,target:null,timeStamp:Date.now(),type:"",view:null,which:0};break;default:throw new TypeError("NotSupportedError: The implementation did not support the requested type of object or operation.")}return k}}if(!("addEventListener" in g.createElement("div"))){var h=f.location,b=h.href,e=h.hash;setInterval(function(){var k=h.href,j=h.hash;if(j!=e&&typeof f.onhashchange==="function"){f.onhashchange({type:"hashchange",oldURL:b,newURL:k});b=k;e=j}},100)}if(typeof f.getComputedStyle!=="function"){f.getComputedStyle=function(m,n){var j={};var k=m.currentStyle||{};for(var l in k){j[l]=k[l]}j.styleFloat=j.cssFloat;j.getPropertyValue=function(p){var o=/(\-([a-z]){1})/g;if(p=="float"){p="styleFloat"}if(o.test(p)){p=p.replace(o,function(){return arguments[2].toUpperCase()})}return m.currentStyle[p]?m.currentStyle[p]:null};return j}}})(window,document);
/*!
